...
$fetch_id_query = $fetch_data_from_db->fetchiddata('books_details', $category_name, $conn, 'book_category');
...
<body class=" w-full h-full bg-slate-900 text-white">
    ...
    <section class="w-full h-full px-2 py-12 mb-12 grid place-items-center space-y-6 ">
