...
foreach ($fetch_admin_table_data as $row) {
                    ...
                    <div class="<?php echo $searchdata ?> gap-2 py-2 mt-2 <?php ?> rounded-md border shadow">
                        <div class="flex justify-between items-center p-2 gap-4 w-full">
                            ...
                            <div class="flex items-center justify-between gap-6">
                                ...
                                <form action="update_categories_data?id=<?php echo $category_id ?>" method="post">
                                ...
                                <button id="<?php echo 'showBookBtn_' . $category_id ?>"
                                    class=" border-2 px-4 py-1 rounded-md">
                                    <?php echo $delete ?>
                                </button>
                                <script>
                                    document.getElementById('<?php echo 'showBookBtn_' . $category_id ?>').addEventListener('click', function () {
                                        var box = document.getElementById('<?php echo 'bookData_' . $category_id ?>');
                                        box.style.display = (box.style.display === 'none' || box.style.display === '') ? 'block' : 'none';
                                    });
                                </script>

                                <div id="<?php echo 'bookData_' . $category_id ?>" class="hidden">
                                        ...
                                        <div
                                            ...
                                            <div class="grid place-items-center gap-4 pb-2">
                                                <h2 class="px-6 font-semibold pt-3 text-black text-center">Are you sure u
                                                    want to delete this category</h2>
                                                <form action="delete_categories?id=<?php echo $category_id ?>" method="post"
                                                    class="">
                                                    <button type="submit"
