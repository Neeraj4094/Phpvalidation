                        ...
                        <ul class="px-2 space-y-2">
                            <li>
                                <div class="flex items-center gap-2 relative pt-2">
                                    <a href="admin" class="absolute inset-0 z-10"></a>
                            ...
                            <li>
                                <div class="flex items-center gap-2 relative">
                                    <a href="books" class="absolute inset-0 z-10"></a>
                            ...
                            <li>
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center gap-2 relative">
                                        <a href="categories" class="absolute inset-0 z-10"></a>
                            ...
                            <li>
                                <div class="flex items-center gap-2 relative">
                                    <a href="users" class="absolute inset-0 z-10"></a>
                                    <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512">
                                        <path
                            ...
                            <li>
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center gap-2 relative">
                                        <a href="orders" class="absolute inset-0 z-10"></a>
                    ...
                    <li class="border-t px-2 py-2">
                        <form action="admin_logout" method="post">
                            <button class="flex items-center gap-2 relative ">
                                <a href="admin_logout" class="absolute inset-0 z-10"></a>
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
