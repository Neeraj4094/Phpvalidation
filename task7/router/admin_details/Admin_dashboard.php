...
<body class="grid grid-cols-12 grid-rows-6 w-full h-full">
        <aside class=" row-span-6 col-span-2 border h-full sm:hidden lg:block"><?php include '../app.php' ?></aside>
            ...
            <div class="p-2 ">
                ...
                <div class="flex items-center justify-between ">
                    ...
                    <a href="admin_registeration"
                        class=" uppercase px-4 py-2 bg-blue-600 text-white rounded-lg"><span class="font-bold text-xl">+</span> Add Admins</a>
                </div>
            </div>
                        ...
                        <div
                            ...
                            <div class=" flex justify-between items-center p-2 gap-4 w-full ">
                                ...
                                <div class="flex items-center justify-between gap-6">
                                    ...
                                    <form action="admin_update?id=<?php echo $checkid ?>" method="post">
