                    ...
                    <li class="border-t px-2 py-2">
                        <form action="./admin_logout.php" method="post">
                            <button class="flex items-center gap-2 relative ">
                                <a href="./admin_logout.php" class="absolute inset-0 z-10"></a>
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ...
        <main class="row-span-6 col-span-10  sm:col-span-12 lg:col-span-10 ">
            ...
            <div class="p-2 ">
                ...
                <div class="flex items-center justify-between ">
                    ...
                    <a href="Registeration_form_in_html.php"
                        class=" uppercase px-4 py-2 bg-blue-600 text-white rounded-lg">+ Add Customers</a>
                </div>
            </div>
            <div class="px-2 border-t">
                <div class="px-2 h-96 space-y-3 overflow-y-scroll">
                    ...
                    foreach ($admin_fetch_data_from_db as $item) {
                        ...
                        ?>
                        <div
                            class="grid gap-2 py-2 sm:block md:grid mt-2 <?php echo $boxColor ?>  rounded-md border w-full shadow">
                            <div class=" flex justify-between items-center p-2 gap-4 w-full ">
                                ...
                                <div class="flex items-center justify-between gap-6">
                                    ...
                                    <form action="admin_update_data.php?id=<?php echo $checkid ?>" method="post">
                                    ...
                                    <form action="delete_admin_account.php?id=<?php echo $checkid ?>" method="post">
