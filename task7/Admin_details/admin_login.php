...
<body>
    ...
    <div class="flex w-full h-screen ">
        ...
        <form action="admin_login" method="post" class="grid px-12 py-8 border bg-white shadow-sm text-slate-500 flex-1"
            name="login_form">
            <div class="max-w-md space-y-4 px-16">
                ...
                <div class="grid space-y-2">
                    ...
                    <input type="password" name="login_password" id="password" placeholder="Enter password"
                        class="border rounded-lg p-2" value="<?php echo $admin_password ?>">
