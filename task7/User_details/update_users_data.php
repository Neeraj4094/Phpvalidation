                ...
                <div class="space-y-1  py-6 px-10 w-full">
                    <div class="flex gap-4">
                        <div class="">
                            ...
                            <input type="text" name="name" id="name" placeholder="Name"
                                class="border rounded-sm w-full p-1" value="<?php echo $fetch_user_name ?>">
                        ...
                        <div class="">
                            ...
                            <input type="text" name="phone_number" id="number" placeholder="Phone number"
                                class="border rounded-sm w-full p-1" value="<?php echo $fetch_user_phone_no ?>">
                    ...
                    <div class="">
                        ...
                        <input type="email" name="email" id="email" placeholder="Email"
                            class="border rounded-sm w-full p-1" value="<?php echo $fetch_user_email ?>">
                        <span class="text-red-600 text-sm">* <small>
                                <?php echo $err_email ?>
                            </small></span>
                    </div>
                    ...
                    <div class="">
                        ...
                        <input type="text" name="address" id="address" placeholder="Address"
                            class="border rounded-sm w-full p-1" value="<?php echo $fetch_user_address ?>">
                        <span class="text-red-600 text-sm max-w-xs w-96">* <small>
