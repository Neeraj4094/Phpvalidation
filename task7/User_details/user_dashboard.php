                        ...
                        <div class=" flex justify-between items-center p-2 gap-4 w-full ">
                            ...
                            <div class="flex items-center justify-between gap-6 pr-2">
                                ...
                                <form action="users?status=<?php echo $user_lock_data ?>" method="post">
                                    ...
                                    <input type="checkbox" hidden checked name="user_account_status" id="user_account_status">
                                    <button type="submit" name="account_status" data-toggle="tooltip" data-placement="top" title="Edit"
