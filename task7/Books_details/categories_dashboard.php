            ...
            <div class="px-2 border-t">
                <div class="px-2 h-96 space-y-3 overflow-y-scroll">
                    ...
                    <form action="#" method="post">
                        ...
                        <?php 
                        $add_books = '<div class="flex w-full h-full items-center justify-center"> <a href="./books_details.php" class="bg-blue-600 text-white rounded-lg shadow px-8 py-2 cursor-pointer">Add Books</a> </div>';
                        ?>
                    ...
                    foreach ($admin_fetch_data_from_db as $item) {
                        ...
                        $book_unique_image_in_db = $item[5];
                        $book_created_date = $item[7];
                        $book_modified_date = $item[8];
                                ...
                                <div class=" flex justify-between items-center gap-4">
                                    <div class=" w-10 h-10 flex items-center justify-center">
                                        ...
                                        if ($book_unique_image_in_db != "") {
                                            ...
                                            $res = "<img src='$images' alt='Image ' class='w-10 h-16 rounded-sm object-cover flex items-center justify-center'>";
                                            echo "$res<br>";
                                        } else {
