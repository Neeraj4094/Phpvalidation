...
$user_email_list = array_unique($user_email_list);
        ...
        <div class="p-2 ">
            ...
            <div class="flex items-center justify-between ">
                <div class="flex items-center relative">
                    <form action="pending_books" method="post" class="flex items-center gap-1 relative">
                            ...
                            <div class="flex items-center gap-10">
                                ...
                                <div id="<?php echo 'bookData_' . $user_rented_id ?>" class="hidden border p-2">
                                    <div
                                        ...
                                        <div class="relative ">
                                            <form action="pending_books" method="post"
                                                class="font-bold text-2xl text-slate-400 absolute right-2 z-20 top-2">
                                                <button type="submit">
                                            ...
                                            <div class="grid gap-2 items-center border rounded-xl bg-white p-12 relative">
                                                <h2
