        ...
        <div class="p-2 ">
            ...
            <div class="flex items-center justify-between ">
                <div class="flex items-center relative">
                    <form action="returned_books" method="post" class="flex items-center gap-1 relative">
                            ...
                            <div class="flex items-center gap-10">
                                <div class="flex items-center gap-1">
                                    <div class="flex items-center gap-1 text-xs">
                                        <p>View Returned book details</p>
                                        <span class="pt-1">
                                ...
                                <div id="<?php echo 'bookData_' . $user_rented_id ?>" class="hidden border p-2">
                                    <div
                                        ...
                                        <div class="relative ">
                                            <form action="returned_books" method="post"
