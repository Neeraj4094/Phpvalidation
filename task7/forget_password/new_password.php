        ...
        <form action="new_password" method="post" class="grid px-12 py-8 border bg-white shadow-sm text-slate-500 flex-1" name="login_form">
            <div class="max-w-md space-y-4 px-16">
                ...
                <div class="grid space-y-2">
                    ...
                    <input type="password" name="new_password" id="new_password" placeholder="New password" class="border rounded-lg p-2" value="<?php echo $new_password ?>">
                    <span class="text-red-600 w-96">* <small><?php echo $err_new_password ?></small></span>
                ...
                <div class="grid space-y-2">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" placeholder="Confirm password" class="border rounded-lg p-2" value="<?php echo $confirm_password ?>">
                    <span class="text-red-600 w-96">* <small><?php echo $err_confirm_password ?></small></span>
                    <!-- <small>(Password must have 1 Capital alphabet, 1 small alphabet, 1 special character & 1 number)</small> -->
                </div>
                
                <div class="">
                <div>
                    <input type="submit" name="reset_password" id="reset_password" class="bg-indigo-500 text-white px-10 py-2 rounded-lg cursor-pointer" value="Submit">
                </div>
