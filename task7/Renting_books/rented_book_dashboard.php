...
//     $rented_days = isset($data[2]) ? $data[2] :'';
//     $address = isset($data[3]) ? $data[3] :'';
//     $state = isset($data[4]) ? $data[4] :'';
//     $city = isset($data[5]) ? $data[5] :'';
//     $pin_code = isset($data[6]) ? $data[6] :'';
//     $address = isset($data[7]) ? $data[7] :'';
//     $issue_date = isset($data[8]) ? $data[8] :'';
//     $return_date = isset($data[9]) ? $data[9] :'';
//     $charges = isset($data[10]) ? $data[10] :'';
//     $card_owner = isset($data[11]) ? $data[11] :'';
//     $card_number = isset($data[12]) ? $data[12] :'';
//     $card_expiration_date = isset($data[13]) ? $data[13] :'';
//     $card_cvc = isset($data[14]) ? $data[14] :'';
...
//         $book_rented_data[$email] = [$user_name,$email,$user_phone_number,$user_gender,$address,$state,$city];
//         // $book_data[] = [$book_name,$book_category,$book_author,$issue_date,$return_date,$charges];
//         $book_data = [$book_name,$book_category,$book_author,$issue_date,$return_date,$charges];
//         $book_rented_data[$email][] = $book_data;
//     }else{
//         $book_data[] = [$book_name,$book_category,$book_author,$issue_date,$return_date,$charges];
//         $merge_book_data[] = isset($book_rented_data[$email][7]) ? $book_rented_data[$email][7] : '';
//         $book_rented_data[$email][7] = array_merge($merge_book_data,$book_data);
//     }
//     $email_list[] = $email;
// }
// $array = array_unique($email_list);
// foreach($array as $email){
//     $rented_data[] = isset($book_rented_data[$email]) ? $book_rented_data[$email] : '';
//     foreach($rented_data as $rent){
//         $user_email = isset($rent[1]) ? $rent[1] :'';
//         $book_name = isset($rent[15]) ? $rent[15] :'';
//         $book_category = isset($rent[16]) ? $rent[16] :'';
//     }
//     // print_r($rented_data);
...
//     $user_name = isset( $rent[0]) ? $rent[0] :'';
//     $user_address = isset( $rent[6]) ? $rent[6] :'';
//     $user_rented_book_details = isset( $rent[7]) ? $rent[7] :'';
//     $book_name = isset( $rent[7][0] ) ? $rent[7][0] :'';
//     // foreach($user_rented_book_details as $books_details){
//     //     $book_name = isset($books_details[0]) ? $books_details[0] :'';
                ...
                <div class="px-2 h-96 space-y-3 overflow-y-scroll">
                    ...
                    foreach ($email_list as $email) {
                        ...
                        foreach ($user_rented_book_details as $user_rented_book_data){
                            $book_name = $user_rented_book_data[0];
                            ...
                            <div class=" flex justify-between items-center p-2 gap-4 w-full ">
                                ...
                                <div class="flex items-center justify-between gap-6">
                                    ...
                                    <p class=" bg-indigo-500 text-white px-3 py-1 rounded-md">
                                        <?php echo "Copies:-" . $book_name ?>
                                    </p>
                                    <p class=" bg-purple-500 text-white px-3 py-1 rounded-md">
                                        <?php echo "Price :- " . $book_category ?>
                                    </p>
                                    </div>
                                    <?php } ?>
